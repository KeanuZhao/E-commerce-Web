...
<div class="register">
<form name="reg"  method="post" action="CheckLoginServlet">
<table class="regtable">
<tr>
<td align="right">Username</td>
<td align="left"><input name="username" type="text" maxlength="20"></td>
</tr>
<tr>
<td align="right">Password</td>
<td align="left"><input name="password" type="password" maxlength="20"></td>
</tr>
